...
public class RespondsTyresABatteries  extends RecyclerView.Adapter<RespondsTyresABatteries.ViewHolder> implements Filterable {
    private ArrayList<Responds> androidList;
    ...
    public RespondsTyresABatteries(Context c, ArrayList<Responds> responses , String orderId) {
    ...
    @Override
    public RespondsTyresABatteries.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout. response_itm, viewGroup, false);


        return new RespondsTyresABatteries.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RespondsTyresABatteries.ViewHolder viewHolder, final int i) {
...
//        };
    ...
    public void add(Responds r) {
        androidList.add(r);
        notifyItemInserted(androidList.size() -1);
    }

    public void addAll(List<Responds> moveResults) {
        for (Responds result : moveResults) {
//            if (!result.getProducts().isEmpty())
            add(result);
        }
    }

    public void remove(Responds r) {
    ...
    private Responds getItem(int position) {
