...
public class RespondsACAdaptore  extends RecyclerView.Adapter<RespondsACAdaptore.ViewHolder> implements Filterable {
    private ArrayList<RespondsAC> androidList;
    ...
    public RespondsACAdaptore(Context c, ArrayList<RespondsAC> responses , String orderId) {
    ...
    @Override
    public RespondsACAdaptore.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout. response_itm, viewGroup, false);


        return new RespondsACAdaptore.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RespondsACAdaptore.ViewHolder viewHolder, final int i) {
...
//        };
    ...
    public void add(RespondsAC r) {
        androidList.add(r);
        notifyItemInserted(androidList.size() -1);
    }

    public void addAll(List<RespondsAC> moveResults) {
        for (RespondsAC result : moveResults) {
//            if (!result.getProducts().isEmpty())
            add(result);
        }
    }

    public void remove(RespondsAC r) {
    ...
    private RespondsAC getItem(int position) {
